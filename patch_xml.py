...
file_path = r"receiver\src\main\res\layout\activity_settings.xml"
with open(file_path, "r", encoding="utf-8") as f:
    content = f.read()

location_card = """            <!-- Location Reminder Card -->
...
content = content.replace("            <!-- Media Card -->\n            <com.google.android.material.card.MaterialCardView", location_card)
